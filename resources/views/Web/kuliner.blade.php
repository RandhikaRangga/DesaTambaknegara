    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Kuliner<i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center pb-4">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h2 class="mb-4">Kuliner Desa Wisata Menari Tambaknegara</h2>
            </div>
        </div>
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="col-md-4 d-flex ftco-animate" style="background-color: white;">
                    <div class="blog-entry justify-content-end">
                        <br>
                        <a class="block-20" style="background-image: url('{{asset('image/'.$kuliner->foto)}}');">
                        </a>
                        <div class="text mt-3 float-right d-block">
                            ...
                            <h3 class="heading"><a>{{$kuliner->nama}}</a></h3>
