    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Daya Tarik</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Daya Tarik<i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row d-flex">
                ...
                <div class="col-md-4 d-flex ftco-animate" style="background-color: white;">
                    <div class="blog-entry justify-content-end">
                        <br>
                        <a class="block-20" style="background-image: url('{{asset('image/'.$wisata->foto)}}');">
                        </a>
                        <div class="text mt-3 float-right d-block">
                            ...
                            <h3 class="heading"><a>{{$wisata->nama}}</a></h3>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a class="block-20" style="background-image: url('{{asset('image/'.$budaya->foto)}}');">
                        </a>
                        <div class="text mt-3 float-right d-block">
                            <div class="d-flex align-items-center mb-4 topp">
                                <div class="two">
                            ...
                            <h3 class="heading"><a>{{$budaya->nama}}</a></h3>
